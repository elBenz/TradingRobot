...
namespace TradingRobot
{
    ...
    public class EWrapperImpl : EWrapper
    {
        ...
        public virtual void tickPrice(int tickerId, int field, double price, TickAttrib attribs)
        {
            ...
            // Send the tick price to the DataHandler
            if (field == 4 || field == 68)
                DataHandler.data.Add(new TickData(tickerId, field, price));
        }
        //! [tickprice]
        ...
        public virtual void tickSnapshotEnd(int tickerId)
        {
            ...
            // Send EndOfData to DataHandler
            DataHandler.data.Add(new EndOfData(tickerId));
        }
        //! [ticksnapshotend]
        ...
        {
            //Console.WriteLine("Hist+oricalData. " + reqId + " - Time: " + bar.Time + ", Open: " + Util.DoubleMaxString(bar.Open) + ", High: " + Util.DoubleMaxString(bar.High) +
            ...
            DataHandler.data.Add(new HistoricalData(reqId, bar.Time, bar.Open, bar.Close, bar.High, bar.Low, bar.Volume, bar.Count, bar.WAP));
        }
        //! [historicaldata]
        ...
        public virtual void historicalDataEnd(int reqId, string startDate, string endDate)
        {
            ...
            // Send EndOfData to DataHandler
            DataHandler.data.Add(new EndOfData(reqId));
        }
        //! [historicaldataend]
